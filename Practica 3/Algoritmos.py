...
if __name__ == "__main__":
    ...
    #'''
    print("------ MLP...")
    #clf = MLPClassifier(hidden_layer_sizes=(100,100),activation= 'relu', learning_rate='adaptive',random_state=seed)
    clf = 
    params_rf = {'hidden_layer_sizes': [(100,60), (100,80), (100,100) ]}
    ...
    #clf = MLPClassifier(activation= 'relu', learning_rate='adaptive',random_state=seed)
    # '''
    """
    ...
    """
    # Creo un Random Forest con los parametros anteriores
